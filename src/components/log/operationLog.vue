<template>
  <div>
    ...
    <el-form inline :model="searchParam" size="small" class="search">
      ...
      <el-form-item>
        <el-input v-model="searchParam.value" placeholder="描述"></el-input>
      </el-form-item>
      <el-form-item>
        <el-select v-model="searchParam.status" placeholder="操作状态" clearable>
    ...
    <el-table :data="logData" border highlight-current-row v-loading="loading" element-loading-text="拼命加载中"
      ...
      <el-table-column prop="url" label="请求地址" min-width="100" align="center" :show-overflow-tooltip="true"/>
      <el-table-column prop="params" label="请求参数" min-width="100" align="center" :show-overflow-tooltip="true"/>
      <el-table-column prop="method" label="执行方法" min-width="100" align="center" :show-overflow-tooltip="true"/>
      <el-table-column prop="execTime" label="执行时间ms" min-width="100" align="center"/>
      <el-table-column prop="status" label="操作状态" min-width="100" align="center" :formatter="statusFormatter"/>
  ...
  export default {
    ...
    methods: {
      ...
      loadData() {
        ...
        this.$axios.get(this.GLOBAL.baseurl + '/log/operation/list', {
